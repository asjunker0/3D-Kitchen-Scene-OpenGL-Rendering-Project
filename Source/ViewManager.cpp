 ...
 *
 *	This method is called automatically from GLFW when the
 *	user scrolls the mouse wheel while the window is open.
 ***********************************************************/

void ViewManager::Mouse_Scroll_Wheel_Callback(GLFWwindow* window, double xOffset, double yOffset)
{
	// Adjusts the camera's speed based on scroll
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process change in perspective modes
	if (glfwGetKey(m_pWindow, GLFW_KEY_P) == GLFW_PRESS) {
		bOrthographicProjection = false; // switch to perspective mode
	}
	if (glfwGetKey(m_pWindow, GLFW_KEY_O) == GLFW_PRESS) {
		bOrthographicProjection = true; // switch to orthogrphic mode
	}
}
